...
export type GetAdminMutation = {
    __typename?: 'Mutation';
    getAdmin: { __typename?: 'adminUserResponse'; id: string; is_username: boolean; is_password: boolean };
};
...
export type CreateAdminCartMutation = {
    __typename?: 'Mutation';
    createAdminCart: { __typename?: 'MutationResponse'; is_error: boolean; message: string };
};
...
export type GetCartItemMutation = {
    __typename?: 'Mutation';
    getCartItem: {
        __typename?: 'Product';
        id: string;
...
export type GetAllCartItemsQuery = {
    __typename?: 'Query';
    getAllCartItems: Array<{
        __typename?: 'Product_cartId';
        id: string;
        product_name: string;
        description: string;
...
export type CreateCategoryMutation = {
    __typename?: 'Mutation';
    createCategory: { __typename?: 'MutationResponse'; is_error: boolean; message: string };
};
...
export type GetAllMediaQuery = {
    __typename?: 'Query';
    getAllMedia: Array<{ __typename?: 'Media'; id: string; title: string; contents: string; img: string; created_at: any } | null>;
};
...
export type CreateProductMutation = {
    __typename?: 'Mutation';
    createProducts: { __typename?: 'MutationResponse'; id: string; is_error: boolean; message: string };
};
...
export type GetProductMutation = {
    __typename?: 'Mutation';
    getProduct: {
        __typename?: 'Product';
        id: string;
...
export type GetAllProductByCategoryMutation = {
    __typename?: 'Mutation';
    getAllProductsByCategory: Array<{
        __typename?: 'Product';
        id: string;
        product_name: string;
        description: string;
...
export type GetAllProductsByKeywordMutation = {
    __typename?: 'Mutation';
    getAllProductsByKeyword: Array<{
        __typename?: 'Product';
        id: string;
        product_name: string;
        description: string;
...
export const GetAdminDocument = `
  ...
  getAdmin(username: $username, password: $password) {
    ...
    `;
export const useGetAdminMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<GetAdminMutation, TError, GetAdminMutationVariables, TContext>(
        ['getAdmin'],
        (variables?: GetAdminMutationVariables) =>
            fetcher<GetAdminMutation, GetAdminMutationVariables>(client, GetAdminDocument, variables, headers)(),
        options,
    );
...
export const useCreateBrandMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<CreateBrandMutation, TError, CreateBrandMutationVariables, TContext>(
        ...
        (variables?: CreateBrandMutationVariables) =>
            fetcher<CreateBrandMutation, CreateBrandMutationVariables>(client, CreateBrandDocument, variables, headers)(),
        options,
    );
...
export const useCreateCartMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<CreateCartMutation, TError, CreateCartMutationVariables, TContext>(
        ...
        (variables?: CreateCartMutationVariables) =>
            fetcher<CreateCartMutation, CreateCartMutationVariables>(client, CreateCartDocument, variables, headers)(),
        options,
    );
export const CreateAdminCartDocument = `
  ...
  createAdminCart(user_id: $user_id, product_id: $product_id) {
    ...
    `;
export const useCreateAdminCartMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<CreateAdminCartMutation, TError, CreateAdminCartMutationVariables, TContext>(
        ['createAdminCart'],
        (variables?: CreateAdminCartMutationVariables) =>
            fetcher<CreateAdminCartMutation, CreateAdminCartMutationVariables>(client, CreateAdminCartDocument, variables, headers)(),
        options,
    );
export const GetCartItemDocument = `
  ...
  getCartItem(id: $id) {
    ...
    `;
export const useGetCartItemMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<GetCartItemMutation, TError, GetCartItemMutationVariables, TContext>(
        ['getCartItem'],
        (variables?: GetCartItemMutationVariables) =>
            fetcher<GetCartItemMutation, GetCartItemMutationVariables>(client, GetCartItemDocument, variables, headers)(),
        options,
    );
...
export const useDeleteCartMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<DeleteCartMutation, TError, DeleteCartMutationVariables, TContext>(
        ['deleteCart'],
        (variables?: DeleteCartMutationVariables) =>
            fetcher<DeleteCartMutation, DeleteCartMutationVariables>(client, DeleteCartDocument, variables, headers)(),
        options,
    );
export const GetAllCartItemsDocument = `
  ...
  getAllCartItems(first: $first, skip: $skip) {
    ...
    `;
export const useGetAllCartItemsQuery = <TData = GetAllCartItemsQuery, TError = unknown>(
    client: GraphQLClient,
...
export const useCreateCategoryMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<CreateCategoryMutation, TError, CreateCategoryMutationVariables, TContext>(
        ...
        (variables?: CreateCategoryMutationVariables) =>
            fetcher<CreateCategoryMutation, CreateCategoryMutationVariables>(client, CreateCategoryDocument, variables, headers)(),
        options,
    );
...
export const useCreateOrderMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<CreateOrderMutation, TError, CreateOrderMutationVariables, TContext>(
        ...
        (variables?: CreateOrderMutationVariables) =>
            fetcher<CreateOrderMutation, CreateOrderMutationVariables>(client, CreateOrderDocument, variables, headers)(),
        options,
    );
export const GetAllOrdersDocument = `
  ...
  getAllOrders(user_id: $user_id) {
    ...
    `;
export const useGetAllOrdersQuery = <TData = GetAllOrdersQuery, TError = unknown>(
    client: GraphQLClient,
...
export const useCreateProductMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<CreateProductMutation, TError, CreateProductMutationVariables, TContext>(
        ...
        (variables?: CreateProductMutationVariables) =>
            fetcher<CreateProductMutation, CreateProductMutationVariables>(client, CreateProductDocument, variables, headers)(),
        options,
    );
export const GetProductDocument = `
  ...
  getProduct(product_id: $product_id) {
    ...
    `;
export const useGetProductMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<GetProductMutation, TError, GetProductMutationVariables, TContext>(
        ['getProduct'],
        (variables?: GetProductMutationVariables) =>
            fetcher<GetProductMutation, GetProductMutationVariables>(client, GetProductDocument, variables, headers)(),
        options,
    );
export const GetAllProductByCategoryDocument = `
  ...
  getAllProductsByCategory(category: $category, first: $first, skip: $skip) {
    ...
    `;
export const useGetAllProductByCategoryMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<GetAllProductByCategoryMutation, TError, GetAllProductByCategoryMutationVariables, TContext>(
        ...
        (variables?: GetAllProductByCategoryMutationVariables) =>
            fetcher<GetAllProductByCategoryMutation, GetAllProductByCategoryMutationVariables>(
                client,
                GetAllProductByCategoryDocument,
                variables,
                headers,
            )(),
        options,
...
export const GetAllProductsByKeywordDocument = `
  ...
  getAllProductsByKeyword(
    ...
    `;
export const useGetAllProductsByKeywordMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<GetAllProductsByKeywordMutation, TError, GetAllProductsByKeywordMutationVariables, TContext>(
        ['getAllProductsByKeyword'],
        (variables?: GetAllProductsByKeywordMutationVariables) =>
            fetcher<GetAllProductsByKeywordMutation, GetAllProductsByKeywordMutationVariables>(
                client,
                GetAllProductsByKeywordDocument,
                variables,
                headers,
            )(),
        options,
...
export const GetAllProductsDocument = `
  ...
  getAllProducts(first: $first, skip: $skip) {
    ...
    `;
export const useGetAllProductsQuery = <TData = GetAllProductsQuery, TError = unknown>(
    client: GraphQLClient,
